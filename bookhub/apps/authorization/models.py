...
class Role(BaseModel):
    ...
    name = models.CharField(
        max_length=50, choices=ROLE_CHOICES, unique=True, verbose_name="Название роли"
    )
...
class AccessRule(BaseModel):
    ...
    role = models.ForeignKey(
        Role, on_delete=models.CASCADE, related_name="access_rules", verbose_name="Роль"
    )
...
class UserRole(BaseModel):
    ...
    role = models.ForeignKey(
        Role, on_delete=models.CASCADE, related_name="user_roles", verbose_name="Роль"
    )
